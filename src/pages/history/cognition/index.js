        ...
        return(
            <div className={'cognition-content'}>
                ...
                <div className={'cognition-content-name'}>
                    <span className={'cognition-content-name-detail'}>主观认知下降，以下几个方面是否有问题？（受访者需要即刻回答）</span>
                ...
                <div className={'cognition-content-name'}>
                    <span className={'cognition-content-name-detail'}>记忆力</span>
                    <div className={'cognition-content-detail'}>
                        <ul className={'cognition-content-detail-title'}>
                ...
                <div className={'cognition-content-name'}>
                    <span className={'cognition-content-name-detail'}>执行能力及空间思维能力</span>
                    <div className={'cognition-content-detail'}>
                        <ul className={'cognition-content-detail-title'}>
